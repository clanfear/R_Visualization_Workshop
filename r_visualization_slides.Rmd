...
Note, however, that most conventional statistical models are just conditional mean models, such as ordinary least squares, generalized linear models. 
...
1. More on geom_smooth()
2. Sankey diagrams?
3. histograms
4. Model results with ggeffects