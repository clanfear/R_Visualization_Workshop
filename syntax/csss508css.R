csss508css <- list(
  ...
  ".inverse" = list("background-image" = "url(https://clanfear.github.io/R_Visualization_Workshop/img/UWTacomaBG1_white.svg)"),
...
mono_accent(base_color = "#342c5c",
            ...
            title_slide_background_image = "https://clanfear.github.io/R_Visualization_Workshop/img/title_slide_img.png",
            title_slide_background_position = "bottom",
            title_slide_background_size = "contain",
            background_image = "https://clanfear.github.io/R_Visualization_Workshop/img/UWTacomaBG1.svg"
)